...
description: 'HTML fragments in email refer to sections of HTML code that can be reused across multiple email campaigns.'
---
...
When creating new emails, any new content that is inserted into a template is also referred to as a fragment.  
