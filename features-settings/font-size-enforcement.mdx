...
description: 'Enforcing min and max font sizes in emails can boost deliverability and accessibility. Ensure readability and optimal display across all devices.'
---
...
# Video Overview of Automatic Font Size Adjustments

<video
  controls
  className="w-full aspect-video"
  src="https://campaigncleaner.com/assets/videos/font-size.mp4"
></video>
