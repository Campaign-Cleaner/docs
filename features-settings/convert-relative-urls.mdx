---
title: 'Converting Relative URLS'
description: 'Description of your new file.'
---

Relative references are not suitable for emails because the absolute path will be of the URL where the email is opened. Not the absolute path of where image is stored.
