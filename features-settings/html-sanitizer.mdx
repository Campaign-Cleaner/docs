...
# What is HTML Sanitizing?

HTML sanitizing is the process of removing potentially harmful HTML code from user-generated content in order to protect against cross-site scripting (XSS) attacks and other vulnerabilities. When it comes to email delivery, HTML sanitizing can be extremely helpful in avoiding the spam box.
...
**Here's an example of HTML sanitizing for an email:**
