...
Clicking the # next to `Images missing ALT Attribute`, brings up an easy to management tools to allow you to quickly update all your `ALT Attributes` at once.


![alt-management-1.png](/images/alt-management-1.png)
...
![title-management-1.png](/images/title-management-1.png)
