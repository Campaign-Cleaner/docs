...
Our [Resize And Host](/features-settings/resize-and-host) feature intelligently scales images to their actual display dimensions, enhancing email load times, before adding it to our CDN.
