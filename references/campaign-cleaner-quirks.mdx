...
<Accordion title="The attributes and styles in the BODY tag disappear">

    <b>Cause:</b> We strip this out this on purpose, a lot of email clients don't support styles in the body tag. A few email clients will convert it to a div tag.

    <b>Solution:</b> Wrap a DIV tag around your campaign HTML and put the styles in the DIV tag.
