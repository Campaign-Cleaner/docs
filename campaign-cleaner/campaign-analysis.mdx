...
For more information about this section, please refer to the  [Punctuation, Caps and H Tags](/features-settings/punctuation-caps-h-tags) settings.

# Spam Keyword Ratio
![spam-keyword-ratio-1.png](/images/spam-keyword-ratio-1.png)
...
For more information about this section, please refer to the [Spam Trigger Detection](/features-settings/spam-trigger-detection) settings.
...
For more information about this section, please refer to the [Broken Link Recursion Checker](/features-settings/broken-link-checker) settings.
...
For more information about this section, please refer to the [Text To Link Analysis](/features-settings/text-to-link-analysis) settings.
...
For more information about this section, please refer to the [Text To Image Analysis](/features-settings/text-to-image-analysis) settings.
...
For more information about this section, please refer to the [Blacklist Link Recursion Checker](/features-settings/blacklist-recursion-checking) settings.
...
For more information about this section, please refer to the [Oversized Image Detection](/features-settings/image-summary) settings.
...
For more information about this section, please refer to the [Background Image Detection](/features-settings/background-image-detectionn) settings.
...
For more information about this section, please refer to the [Unsupported Image Detection](/features-settings/unsupported-image-detection) settings.
...
For more information about this section, please refer to the [Poor Delivery CDN Detection](/features-settings/poor-delivery-cdn-detection) settings.
