...
![punctuation-4.png](/punctuation-4.png)
...
For more information about this section, please refer to the  [Punctuation, Caps and H Tags](/punctuation-caps-h-tags) settings.
<br>
 

# Spam Keyword Ratio
![spam-keyword-ratio-1.png](/spam-keyword-ratio-2.png)

This section highlights any spam keywords found in the content of your email campaign. While it's nearly impossible to have zero spam keywords, having an excessive amount of them can raise a red flag. For instance, if a particular spam keyword, such as "Free," is used multiple times in conjunction with other spam keywords, it can make your email appear very spammy and suspicious. In this example, "Free" is used 8 times, which is considered high and may result in a lower deliverability rate. 

For more information about this section, please refer to the [Spam Trigger Detection](/spam-trigger-detection) settings.

# Link Summary

![broken-links-2.png](/broken-links-2.png)
...
For more information about this section, please refer to the [Broken Link Recursion Checker](/broken-link-checker) settings.

# Text To Link Ratio

![text-link-2.png](/text-link-2.png)
...
For more information about this section, please refer to the [Text To Link Analysis](/text-to-link-analysis) settings.

# Text to Image Ratio
![text-image-2.png](/text-image-2.png)
...
For more information about this section, please refer to the [Text To Image Analysis](/text-to-image-analysis) settings.

# Blacklisted Domains

![blacklist-recursion-3.png](/blacklist-recursion-3.png)
...
For more information about this section, please refer to the [Blacklist Link Recursion Checker](/blacklist-recursion-checking) settings.

# Image Summary
![oversized-images-2.png](/oversized-images-2.png)
...
For more information about this section, please refer to the [Oversized Image Detection](/oversized-image-detection) settings.
...
For more information about this section, please refer to the [Background Image Detection](/background-image-detection) settings.
...
For more information about this section, please refer to the [Unsupported Image Detection](/unsupported-image-detection) settings.

# Poor Delivery CDN Detection
![poor-delivery-cdn-3.png](/poor-delivery-cdn-3.png)
...
For more information about this section, please refer to the [Poor Delivery CDN Detection](/poor-delivery-cdn-detection) settings.